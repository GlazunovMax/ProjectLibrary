...
<div class="header_menu">
	...
	<a href="addBooks.jsp"> Добавить книгу </a> <span>/</span>
	<a href="registrationAdmin.jsp"> Зарегистрироваться как администратор </a> <span>/</span> 
	...
	<form class="search_form" action="Controller" method="post">
		...
		<input type="hidden" name="pageNumber" value="1" /> 
		<input type="hidden" name="search" value="searchAdmin"/>
<!-- 		<input type="hidden" name="rowsPerPage" value="2"/> -->
<%-- 		 <jsp:useBean id="dbBookDao" class="by.htp.library.dao.impl.DatabaseBookDao" scope="page" />  --%>
<%-- 		<input type="hidden" name="countAllBook" value="${dbBookDao.getBooksCount()}" />  --%>
